<%@ Page Title="Ana Sayfa" Language="C#" AutoEventWireup="true"
    CodeFile="Video.aspx.cs" Inherits="_Default" %>
...
Cep: 05432264924
  ...
  <div id="sol">
    ...
    <div id="yrm">
        ...
        <br />
&nbsp;<asp:TextBox ID="TextBox4" runat="server" Height="146px" Width="230px"></asp:TextBox>
        <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div id="sag">
      ...
      <br />
&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <asp:MediaPlayer ID="MediaPlayer1" runat="server" Height="360px" 
          mediaskinsource="~/Simple.xaml" MediaSource="~/videos/araba.wmv" Volume="1" 
          Width="470px" BorderStyle="Dotted" Windowless="True">
      </asp:MediaPlayer>
      <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <asp:MediaPlayer ID="MediaPlayer2" runat="server" BorderStyle="Dotted" 
          Height="240px" mediaskinsource="~/Simple.xaml" MediaSource="~/videos/oto.wmv" 
          Volume="1" Width="320px" Windowless="True">
      </asp:MediaPlayer>
      <br />
