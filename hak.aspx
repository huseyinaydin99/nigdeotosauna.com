<%@ Page Title="Ana Sayfa" Language="C#" AutoEventWireup="true"
    CodeFile="hak.aspx.cs" Inherits="_Default" %>
  ...
  <div id="menu">
    ...
    <div id="mn">
      <ul id="deneme">
        ...
        <li><a class="tikla" href="hak.aspx">HakkImIzda</a></li>
      </ul>
    </div>
  </div>
  <div id="sol">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div id="sag"><p id="bs">MİSYONUMUZ</p><br />
<p id="ps">Dinamik bir ekip çalışması ile hızlı, rekabetçi ve 						müşterilerimizin beklentilerini karşılayan hizmetler 						sunmaktır. Hedef alanımız, yalnızca bulunduğumuz şehir 						veya ülke değil tüm dünyadır. Global ticaret hayatında 						entegre bilgi teknolojimizin getirdiği olanaklarla 						ulaştırma sektöründe lider olma hedefimizin 						gerçekleşmekte olduğunu görüyoruz.</p><br />
<br />
<p id="pss">VİZYONUMUZ</p><br />
<p id="bbs">OTOSAUNA, tasarımını ve imalatını yaptığı yeni çevre 						dostu ürünler sayesinde, kaliteli ve yenilikçi 						atılımları ile, birinci sınıf bir dünya şirketi olmayı 						hedeflemektedir. Yüzyıl'ın evrensel ticaret hayatında 						bir numara olabilmek için, tüm müşterilerimizin istek ve 						ihtiyaçlarını karşılayacak ürünler, hizmetler ve pazar 						stratejileri sunmaya devam etmektedir. Çalışanlarımıza, 						ortaklarımıza,müşterilerimize davranışlarımızda; 						karşılıklı saygı, itibar ve dürüstlük temel 						ilkelerimizdir.</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="nnn"><img src="images/wlogo.png" width="381" height="82" /></div></p>
<br />
  </div>
</div>
    </form>
