<%@ Page Title="Ana Sayfa" Language="C#" AutoEventWireup="true"
    CodeFile="ilet.aspx.cs" Inherits="_Default" %>
  ...
  <div id="menu">
    ...
    <div id="mn">
      <ul id="deneme">
        ...
        <li><a class="tikla" href="ilet.aspx">İletiSim</a></li>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <div id="sag">
    <p id="ilet">İletişim Bilgileri</p>
    <p id="bs">ADRES:NİĞDE AUTO SAUNA & OTO YIKAMA 
ATA SANAYİ SİTESİ DURAK TİC. KARŞISI
51100 NİĞDE
TÜRKİYE</p>
<p id="ps">Telefon: 0388 232 00 88
Cep: 05432264924</p>
<p id="pps">AUTO SAUNA<br />
NİĞDE DE İLK VE TEK OTO SAUNA HİZMETİ
  ARABASINI SEVENLERE
  <br /><br />
  •BUHARLI OTO TEMİZLEME<br />
  •BUHARLI İÇ TEMİZLEME PETEK VE KLİMA TEMİZLEME<br />
  •BUHARLI MOTOR TEMİZLEME CILA VE BOYA <br />
  •FAR TEMİZLEME<br />
  •MOBİL YIKAMA </p>
  </div>
</div>
